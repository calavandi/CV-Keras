...
model.add(MaxPool2D(2,2)) #returns 11x11x64
model.add((Dropout(0.2)))

model.add(Convolution2D(32, 3, 3, activation='relu')) #9x9x32
model.add(Convolution2D(10, 3, 3, activation='relu')) #returs 7x7x10
model.add((Dropout(0.2)))

model.add(Convolution2D(10, 7))  #returns 1x1x10
...
model.fit(X_train, Y_train, batch_size=2500,   nb_epoch=200, verbose=1, callbacks=callback_list, validation_data=(X_test, Y_test))
