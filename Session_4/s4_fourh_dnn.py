...
model.add(Convolution2D(16, 3, 3, activation='relu')) #returns 24x24x16
model.add(BatchNormalization())
model.add(Dropout(0.2))

model.add(Convolution2D(8, 3, 3, activation='relu')) #returns 22x22x16
model.add(BatchNormalization())
model.add(Dropout(0.2))

model.add(MaxPool2D(2,2)) #returns11x11x16

model.add(Convolution2D(10, 3, 3, activation='relu')) #returns 9x9x10
model.add(BatchNormalization())
model.add(Dropout(0.2))

model.add(Convolution2D(8, 3, 3, activation = 'relu')) #7x7x10
model.add(BatchNormalization()) 
model.add(Dropout(0.2))

model.add(Convolution2D(8, 3, 3, activation='relu')) #returs 5x5x8
model.add(BatchNormalization())
model.add(Dropout(0.2))

model.add(Convolution2D(12,1,1, activation='relu')) # returns 5x5x14
...
model.fit(X_train, Y_train, batch_size=128, nb_epoch=50 , verbose=1, callbacks=callback_list, validation_data=(X_test, Y_test))
