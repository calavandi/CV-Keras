...
Original file is located at
    https://colab.research.google.com/drive/1hnFMRLzY_4s7eSrlDmMp4bZfJNuLCqdx
...
*   Added dropouts
*   Changed the architecture slightly.
*   Changed the batch size.
###Observations

1.   Slight increase in the accuracy
2.   Smaller epoch time: This is because of the increased batch size.
3.   The val accuracy is greater than test accuracy. This is because of the dropouts added.
"""
...
model.add(Convolution2D(8, 3, 3, activation='relu')) #10x8x8

model.add(MaxPool2D(2,2)) #returns 12x12

model.add(Dropout(0.2))

model.add(Convolution2D(10, 3, 3, activation='relu')) #10x8x8

model.add(Convolution2D(8, 3, 3, activation = 'relu')) #8x8x16

model.add(Dropout(0.2))
model.add(Convolution2D(12,1,1, activation='relu'))

model.add(Convolution2D(10, 7, 7))  #returns 1x1x10
